...
const HomeScreen = ({ navigation }) => {
  ...
  const [dpoint, setDponit] = useState("");
  ...
  const newPost = (
    ...
    axios
      .post(
        `http://192.168.0.197:3100/post?operatorId=${id}&busName=${busname}&busRno=${busno}&password=${pass}&route=${route}&startPoint=${spoint}&lastPoint=${dpoint}&stop1=${stop1}&stop=${stop2}&stop=${stop3}&stop4=${stop4}&stop=${stop5}&stop=${stop6}&stop1time=${stop1time}&stop2time=${stop2time}&stop3time=${stop3time}&stop4time=${stop4time}&stop5time=${stop5time}&stop6time=${stop6time}&status= ${status}`
      )
      .then((res) => {
